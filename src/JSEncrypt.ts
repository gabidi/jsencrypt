...
export default class JSEncrypt {
  private secureRandom:SecureRandom | undefined;
  constructor(options:IJSEncryptOptions) {
    ...
    this.key = null;
    this.secureRandom = options.secureRandom || undefined;
  }
  ...
  public setKey(key:string) {
    ...
    this.key = new JSEncryptRSAKey({ key, secureRandom: this.secureRandom || undefined });
  }
  ...
  public getKey(cb?:() => void) {
    ...
    if (!this.key) {
      ...
      this.key = new JSEncryptRSAKey({ secureRandom:this.secureRandom || undefined });
